...
<a href="#" class="btn btn-default btn-lg disabled" aria-disabled="true"><i class="fa-solid fa-table-list"></i> <span class="network-name">Registration Closed</span></a>
...
Q: Do you provide financial support?<br/>
